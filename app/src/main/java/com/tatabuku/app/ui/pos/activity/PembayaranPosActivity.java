...
import com.tatabuku.app.databinding.ActivityPembayaranPosBinding;
...
import com.tatabuku.app.ui.pembelian.pembayaran.PembayaranListAdapter;
...
import com.tatabuku.app.ui.pembelian.pembayaran.PopupProdukListAdapter;
import com.tatabuku.app.ui.pos.PembayaranPosViewModel;
import com.tatabuku.app.ui.pos.adapter.PembayaranPosListAdapter;
import com.tatabuku.app.ui.pos.adapter.PopupProdukListPosAdapter;
import com.tatabuku.app.ui.pos.listener.PembayaranPosListener;
import com.tatabuku.app.util.StringHelper;

import java.util.List;

public class PembayaranPosActivity extends BaseActivity implements PembayaranPosListener {

    private ActivityPembayaranPosBinding binding;
    private PembayaranPosListAdapter listAdapter;
    private LinearLayoutManager layoutManager;
    private PembayaranPosViewModel viewModel;
    ...
    private void setupViewModel() {
        viewModel = new ViewModelProvider(this).get(PembayaranPosViewModel.class);
    }
...
//                }
    ...
    private void setupView() {
        binding = ActivityPembayaranPosBinding.inflate(getLayoutInflater());
    ...
    private void setupList() {
        ...
        listAdapter = new PembayaranPosListAdapter(viewModel, this);
    ...
    public void showDialog() {
        ...
        PopupProdukListPosAdapter adapter = new PopupProdukListPosAdapter(viewModel, this);
