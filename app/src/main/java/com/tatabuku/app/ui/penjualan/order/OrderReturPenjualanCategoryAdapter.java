...
public class OrderReturPenjualanCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OrderReturPenjualanCategoryAdapter(Context context, OrderReturPenjualanViewModel viewModel) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new OrderReturPenjualanCategoryAdapter.ViewHolder(CategoryItemBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }
