...
public class PembayaranCustomerViewModel extends ViewModel {
    ...
    public PembayaranCustomerViewModel() {
    ...
    public void cancelPaymentData(int id) {
        Call<SubmitOrderResponse> call = ConnectionManager.getInstance().getService().cancelCustomerPaymentData(new PaymentDataModel(new PaymentDataParams(id)));
    ...
    private void submitPembayaran(int id) {
        ...
        Call<SubmitOrderResponse> call = ConnectionManager.getInstance().getService().submitCustomerPaymentData(model);
        call.enqueue(new Callback<SubmitOrderResponse>() {
            @Override
            public void onResponse(Call<SubmitOrderResponse> call, Response<SubmitOrderResponse> response) {
                if (response.body() != null) {
