...
public class OrderPenjualanCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OrderPenjualanCategoryAdapter(Context context, OrderPenjualanViewModel viewModel) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new OrderPenjualanCategoryAdapter.ViewHolder(CategoryItemBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }
