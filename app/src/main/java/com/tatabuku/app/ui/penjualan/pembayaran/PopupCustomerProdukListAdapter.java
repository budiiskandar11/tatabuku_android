...
public class PopupCustomerProdukListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private PembayaranCustomerViewModel viewModel;
    private Context context;

    public PopupCustomerProdukListAdapter(PembayaranCustomerViewModel viewModel, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PopupCustomerProdukListAdapter.ViewHolder(PopupOrderListItemBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }
