...
import com.tatabuku.app.databinding.ActivityPembayaranCustomerBinding;
...
public class PembayaranCustomerActivity extends BaseActivity implements PembayaranListener {

    private ActivityPembayaranCustomerBinding binding;
    private PembayaranCustomerListAdapter listAdapter;
    ...
    private void setupViewModel() {
        viewModel = new ViewModelProvider(this).get(PembayaranCustomerViewModel.class);
    }
...
//                binding.phone.setText(viewModel.getSupplierResult().getValue().getPhone());
        ...
        viewModel.getPaymentData().observe(this, new Observer<PaymentDataResult>() {
            ...
            public void onChanged(PaymentDataResult paymentDataResult) {
                ...
                binding.date.setText(String.format(getString(R.string.tanggal_n), StringHelper.formatInvoiceDate(paymentDataResult.getInvoiceData().getDate())));
...
////                    try {
////                        Glide.with(PembayaranCustomerActivity.this).asBitmap()
...
//                }
    ...
    private void setupView() {
        binding = ActivityPembayaranCustomerBinding.inflate(getLayoutInflater());
    ...
    private void setupList() {
        ...
        listAdapter = new PembayaranCustomerListAdapter(viewModel, this);
    ...
    public void showDialog() {
        ...
        PopupCustomerProdukListAdapter adapter = new PopupCustomerProdukListAdapter(viewModel, this);
