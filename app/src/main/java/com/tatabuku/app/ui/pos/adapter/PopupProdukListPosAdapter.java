...
public class PopupProdukListPosAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private PembayaranPosViewModel viewModel;
    private Context context;

    public PopupProdukListPosAdapter(PembayaranPosViewModel viewModel, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PopupProdukListPosAdapter.ViewHolder(PopupOrderListItemBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }
