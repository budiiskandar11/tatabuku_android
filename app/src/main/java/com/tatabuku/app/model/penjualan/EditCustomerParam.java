...
public class EditCustomerParam {
    ...
    public EditCustomerParam(Integer partner_id,String name, String street, String street2, String email, String mobile, Double credit_limit,
                             Double debit_limit, Integer property_payment_term_id, String vat, String status_pajak, String state_id, String city_id, String subdistrict_id, String zip) {
